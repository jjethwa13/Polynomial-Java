...
public class Complex {
    ...
    public Complex conjugate() {
        // You need to fill in this method.
    	Complex z = new Complex(this.x, -this.y);
    	return z;
    }
    ...
    public Complex add(Complex b) {
    	...
    	z.setReal(this.x + b.getReal());
    	z.setImag(this.y + b.getImag());
    ...
    public Complex multiply(double alpha) {
        // You need to fill in this method.
    	Complex z = new Complex();
    	z.setReal(alpha*this.x);
    	z.setImag(alpha*this.y);
    ...
    public Complex multiply(Complex b) {
        // You need to fill in this method.
    	Complex z = new Complex();
    	z.setReal((this.x*b.getReal()) - (this.y*b.getImag()));
    	z.setImag((this.x*b.getImag()) + (this.y*b.getReal()));
    ...
    public Complex divide(Complex b) {
    	...
    	bconj = b.conjugate();
    	bconj = bconj.multiply(1/b.abs2());
    	
    	Complex z = this.multiply(bconj);
